...
/**
 * Command class to handle command line instructions.
 * 
 * @author Sumit Sharma
...
public class Command implements Serializable {
    ...
    /**
     * establish a Getter method for the root command.
     * 
     * @return string the rootcommand from the series of commands entered by the
     *         player
     */
    ...
    /**
     * Iterates through the list of operations received from the player.
     * 
    ...
    /**
     * Manages all the operations and arguments provided by the player.
     * 
    ...
    /**
     * This method verifies whether the map chosen by the user contains the
     * specified keys or not.
     * 
